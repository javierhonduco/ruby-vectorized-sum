...
srcdir = .
topdir = /Users/javierhonduco/.rbenv/versions/2.2.3/include/ruby-2.2.0
hdrdir = $(topdir)
arch_hdrdir = /Users/javierhonduco/.rbenv/versions/2.2.3/include/ruby-2.2.0/x86_64-darwin13
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Users/javierhonduco/.rbenv/versions/2.2.3
...
DEFS     =
CPPFLAGS = -DRUBY_EXTCONF_H=\"$(RUBY_EXTCONF_H)\" -I/Users/javierhonduco/.rbenv/versions/2.2.3/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)
CXXFLAGS = $(CCDLFLAGS) $(cxxflags) $(ARCH_FLAG)
ldflags  = -L. -L/Users/javierhonduco/.rbenv/versions/2.2.3/lib  -fstack-protector -L/usr/local/lib
...
ORIG_SRCS = fast_sum.c
SRCS = $(ORIG_SRCS)
OBJS = fast_sum.o
HDRS = $(srcdir)/extconf.h
TARGET = fast_sum
TARGET_NAME = fast_sum
